...
// Buatlah sebuah prosedur rekursif untuk menampilkan pola bilangan bulat yang menyatakan baris hingga membentuk pola X yang berukuran N × N.

// Masukan berupa sebuah bilangan bulat positif N.
// Keluaran berupa pola bilangan bulat yang menyatakan baris hingga membentuk pola X yang berukuran N × N.
